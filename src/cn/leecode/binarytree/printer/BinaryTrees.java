package cn.leecode.binarytree.printer;
...
public final class BinaryTrees {
    ...
    private static BasePrinter printer(BinaryTreeInfo tree, PrintStyle style) {
        if (style == PrintStyle.INORDER) return new InorderBasePrinter(tree);
        return new LevelOrderBasePrinter(tree);
    }
